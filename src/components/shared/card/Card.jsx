    ...
    return (
        <div className="card w-full bg-purple-50 shadow-xl group ">
            ...
            <div className="card-body space-y-4">
                ...
                <div className="flex">
                    <p><span className="font-semibold p-3 border rounded-full bg-blue-800"><HiUserGroup className="inline-block text-slate-100"></HiUserGroup></span> {available_seats} Available</p>
                    <p><span className="font-semibold p-3 border rounded-full bg-blue-800"><HiUserGroup className="inline-block text-slate-100"></HiUserGroup></span> {total_set} Student</p>
